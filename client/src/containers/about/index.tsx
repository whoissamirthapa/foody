...
import IndvFeatureAbout from "./indvFeature";
    ...
    return (
        <>
            ...
            <div className="px-[3px] md:px-[20px]">
                <header className="header_about_page min-h-[400px] px-4 md:px-12 lg:px-32 text-center flex flex-col items-center justify-center text-white">
                    <h1 className="text-5xl mb-4">About</h1>
                    <p className="md:px-32 text-lg">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Donec Lorem ipsum dolor sit, amet consectetur
                        adipisicing elit. Facere assumenda repellendus
                        distinctio officiis eum nisi sapiente quidem neque quia,
                        ad, fugit aut blanditiis necessitatibus voluptate
                        consequuntur porro quos animi officia.
                    </p>
                </header>
                <section className="md:my-12 flex md:flex-row items-center flex-col-reverse md:my-8 my-8">
                    <section className="md:w-1/2 mt-8 md:mt-0">
                        <svg
                            ...
                            className="md:w-full sm:w-10/12 sm:m-auto md:m-0 w-full sm:h-auto h-full lg:w-10/12 lg:m-auto"
                        >
                            <path
                    ...
                    <section className="md:w-1/2 md:ml-4 md:pl-8 bg-orange-300 h-1/1 py-12 rounded-xl">
                        <header className="text-3xl mb-2 pr-4 pl-4">
                            Our Mission
                        </header>
                        <section className="lg:pr-8 pr-4 pl-4">
                            Lorem ipsum dolor sit, amet consectetur adipisicing
                            elit. Saepe est praesentium culpa adipisci, esse
                            incidunt a accusamus voluptatibus molestiae autem
                            quia excepturi dolores quisquam delectus ullam
                            assumenda, et dolor cumque.
                            <br />
                            <br />
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Deleniti error, nobis consequuntur iste
                            tempore rem ducimus corporis ipsum accusamus id?
                        </section>
                    </section>
                </section>
                <section className="md:my-24 my-4 w-full">
                    <header className="mb-4 md:mb-8 text-3xl border-l-4 pl-2 border-orange-400">
                        Our Features
                    </header>
                    <section className="flex w-full flex-wrap justify-around sm:flex-row flex-col items-center">
                        {feature &&
                            feature.map((item, index) => {
                                return (
                                    <IndvFeatureAbout item={item} key={index} />
                                );
                            })}
                    </section>
                </section>
